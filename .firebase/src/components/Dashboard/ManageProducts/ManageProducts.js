    ...
    return (
        <div>
            <Container className="py-5">
                ...
                <h4 className='text-primary'>All products: {allProducts.length}</h4>
                ...
                {allProducts.length ? allProducts.map(product => <Row
                    ...
                    <Col md={2} xs={12}><h5 className="mb-0 mt-2 fs-6 text-start ps-3">{product.name}</h5></Col>
                    ...
                    <Col md={2} xs={6}>
                        <p className="my-2 text-center"><Button variant="danger" className=" ms-3" onClick={() => handleDeleteProduct(product._id)}>Delete <i className="fas fa-trash"  ></i></Button></p>
                    </Col>
